    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"> {{$galeri->name}}  PDF Ekle</h4>
            </div>
            @if (count($errors) > 0)
            ...
            @endif
            <div class="card-body">
                <img class="w-52 h-64 rounded-xxxl" src="{{asset("vendor/upload/kataloglar/". $galeri->image)}}" alt="" />
                    <hr>
